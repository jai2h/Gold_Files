...
if DevAbs:get(Antak.."Abs:Lock:ProNames"..msg.chat_id_) and DevAbs:get(Antak.."Abs:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevAbs:get(Antak.."Abs:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevAbs:srem(Antak..'Abs:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevAbs:get(Antak.."Abs:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevAbs:get(Antak.."Abs:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0

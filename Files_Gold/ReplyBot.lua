...
if not DevRio:get(Antak..'Rio:Lock:Reply'..msg.chat_id_) then
...
Dev_Rio(msg.chat_id_, msg.id_, 1, AntakTEAM[DevRio2] , 1, 'md') 
return false
end
...
DevRio:del(Antak..'Rio:Lock:Reply'..msg.chat_id_)
end end
if text == 'تعطيل ردود البوت' or text == 'تعطيل الردود' then
if DevRio:get(Antak..'Rio:Lock:Reply'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '⌁︙ردود البوت بالتاكيد معطله ', 1, 'md')
else
DevRio:set(Antak..'Rio:Lock:Reply'..msg.chat_id_,true)
